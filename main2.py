...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = ttk.Button(
            self, text="1-CREATE NEW ACCOUNT", command=lambda: controller.show_frame(Page1)
        )
        ...
        button2 = ttk.Button(
            self, text="2-LOGIN to ur account", command=lambda: controller.show_frame(Page2)
        )
        ...
        button3 = ttk.Button(
            self, text="3-SEARCH FOR ITEMS", command=lambda: controller.show_frame(Page3)
        )
        button3.grid(row=3, column=1, padx=10, pady=10)

        button4 = ttk.Button(
            self, text="4-VIEW THE ITEMS", command=lambda: controller.show_frame(Page4)
        )
        button4.grid(row=4, column=1, padx=10, pady=10)

        button5 = ttk.Button(
            self, text="5-ORDER", command=lambda: controller.show_frame(Page5)
        )
