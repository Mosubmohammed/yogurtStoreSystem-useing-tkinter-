...
class Page1(tk.Frame):
    def __init__(self, parent, controller, customers_acc):
        ...
        button2.grid(row=12, column=1, padx=10, pady=10)
...
class Page3(tk.Frame):
    def __init__(self, parent, controller, items_list, *args, **kwargs):
        ...
        self.label_search.grid(row=2, column=1, padx=10, pady=10)

        self.entry_search = tk.Entry(self)
        self.entry_search.grid(row=2, column=2, padx=10, pady=10)
...
class Page4(tk.Frame): 
    def __init__(self, parent, controller, *args, **kwargs):
        ...
        button1 = ttk.Button(self, text="SEARCH", command=lambda: controller.show_frame(StartPage))
